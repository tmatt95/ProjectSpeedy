namespace ProjectSpeedy.Services
{
    ...
    interface BetInterface
    {
        ...
        ProjectSpeedy.Bet.BetView Get(string projectId, string problemId, string betId);
        ...
        bool Create(string projectId, string problemId, ProjectSpeedy.Bet.BetNew form);
        ...
        bool Update(string projectId, string problemId, string betId, ProjectSpeedy.Bet.BetNew form);
